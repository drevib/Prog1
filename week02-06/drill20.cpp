...
int main()
{
	...
	vector<int>v2=v;
	list<int>l2=l; //Ezek lesznek a base konténerk
	...
	m_copy(begin(a),end(a),begin(v2)); // növelt tömbböl, az alap vectorba
	for (auto x: v2)
		cout<<x<<' '; cout<<endl;

	cout<<"Copied increased list into base(second) array: ";
	m_copy(l.begin(),l.end(),begin(a2)); //növelt lista, az alap tömbbe
	for (auto x: a2)
		cout<<x<<' '; cout<<endl;
